  ...
  return (
    <div>
      ...
      <section style={{marginBottom:24}}>
        ...
        <DocumentsCarousel docs={docs.length ? docs : [
          {name:'Insurance', type:'Insurance', issuedDate:'2023-01-01', expiry:'2024-01-01', vehicle:{company:'Toyota', model:'Corolla', regDate:'2019-06-10'}},
          {name:'Emission Certificate', type:'Emission Certificate', issuedDate:'2023-03-01', expiry:'2025-03-01', vehicle:{company:'Honda', model:'Civic', regDate:'2020-02-14'}},
          {name:'Warranty', type:'Warranty', issuedDate:'2022-05-01', expiry:'2026-05-01', vehicle:{company:'Ford', model:'Figo', regDate:'2018-11-02'}},
          {name:'RC', type:'RC', issuedDate:'2019-06-10', expiry:'2029-06-10', vehicle:{company:'Hyundai', model:'i20', regDate:'2019-06-10'}},
        ]} />
      </section>
